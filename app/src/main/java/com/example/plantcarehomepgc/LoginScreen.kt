...
fun LoginScreen(onClickRegister :() -> Unit = {}, onSuccessfulLogin :() -> Unit = {}){
    ...
    Scaffold { paddingValues ->
        Column(modifier = Modifier
            ...
            val keyboardCapatilization = null
            val keyboardCapitalization = null
            OutlinedTextField(
                value = inputEmail,
            ...
            Button(onClick = {
                ...
                //Validaciones
                val isValidEmail: Boolean = validateEmail(inputEmail).first // toma el primer valor el Boolean
                val isValidPassword: Boolean = validatePassword((inputPassword)).first
                emailError = validateEmail(inputEmail).second // toma el segundo valor string
