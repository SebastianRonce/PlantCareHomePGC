...
fun RegisterScreen (onClickBack :() -> Unit = {}, onSuccessfulRegister :() -> Unit = {}){
    ...
    // Se usa LocalContext.current para obtener el contexto de manera segura.
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                "Ingresa tu nombre de usuario, correo electrónico para registrarse",
                fontSize = 15.sp,
                fontWeight = FontWeight.Bold,
                color = Color(0xFF000000),
            ...
            Button(
                onClick = {
                    // Se movió el acceso a Firebase y el cast de Activity aquí para evitar el error en el Preview
                    ...
                    if (isValidName && isValidEmail && isValidPassword && isValidConfirmPassword){
                        ...
                        registerError = "Hubo un error al registrarse"
                    }
